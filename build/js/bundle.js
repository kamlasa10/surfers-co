...
var slider = require('./plugins/slick');

var player = require('./plugins/video-player');

window.addEventListener('DOMContentLoaded', function () {
  var trigger = document.querySelector('.burger-menu-btn');
  var content = document.querySelector('.navigation__wrap');
  var links = document.querySelectorAll('.navigation__link');

  var toggleDispaly = function toggleDispaly(trigger, content) {
...
},{"./plugins/slick":5,"./plugins/video-player":6}],4:[function(require,module,exports){
"use strict";
...
module.exports = function (slide) {
  var who = slide.find('.boards__img-big');
  var nav = slide.find('.boards__gallery');
...
module.exports = function () {
  $(document).ready(function () {
    var $wrap = $('.boards__wrap');
    var $status = $('.boards__info');
    $wrap.on('init afterChange', function (event, slick) {
      var currentSlide = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

      if ($(event.target).hasClass('boards__wrap')) {
        var dataId = $('.boards__wrap .slick-current');
        tabs(dataId);
        gallery(dataId);
    ...
    $wrap.on('beforeChange', function (event, slick) {
      var currentSlide = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      var nextSlide = arguments.length > 3 ? arguments[3] : undefined;

      if ($(event.target).hasClass('boards__wrap')) {
        var elem = $('.boards__wrap .boards__item').eq(nextSlide);
        tabs(elem);
        gallery(elem);
      }
    });
...
},{"../tabs":7,"./gallery":4,"jquery":1,"slick-carousel":2}],6:[function(require,module,exports){
"use strict";
...
module.exports = function (current) {
  function bindTabs(triggerSelector, contentSelector, activeSelector) {
    var content = current.find(contentSelector);
    var trigger = current.find(triggerSelector);
